...
import {
  ...
  Plus, Minus, Save, Check, Clock, Settings, UserPlus, HelpCircle, Moon, Sun
} from 'lucide-react';
    ...
    <div className="pb-24 space-y-4 relative">
      <div className="flex justify-between items-center mb-4 px-1">
        ...
        {!isVisitor && (
          <button
            onClick={addPlayer}
            className="flex items-center gap-1 px-4 py-2 bg-[color:var(--theme-green-light)] text-[#00A859] rounded-md font-bold transition-colors shadow-sm text-sm"
          >
            ...
            >
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex-1">
                  <input
                    className={`w-full border-b border-[color:var(--theme-border)] focus:border-[#00A859] px-1 py-1 font-semibold text-lg placeholder:text-[color:var(--theme-text-muted)] placeholder:font-normal ${isVisitor ? 'pointer-events-none' : ''}`}
                    value={p.name}
                    readOnly={isVisitor}
